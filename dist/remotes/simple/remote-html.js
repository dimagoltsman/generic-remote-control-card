...
function getRemoteHtml_simple(config){return `
 ...
 <div class="container">
			...
			<div id="remote-control-${template}">
				...
				<ul>
					<li class="myButton-${template}" id="exit"><a href="#" title="exit full gallery"><span>exit</span></a></li>
					<li class="myButton-${template}" id="info"><a href="#" title="Info on gallery"><span>Info</span></a></li>
